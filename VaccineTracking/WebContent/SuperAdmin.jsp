...
.formright div input[type=submit] {
    /* Size and position */
    width: 45%;
    padding: 8px 5px;
...
<form action="makeadmin" method="post" class="formright">
<div>
<h1>Make Admin</h1>
<input type="hidden" name="csrfToken" value="<%= csrfToken %>"/>
Contact Number:<input type="text" name="contactnumber"><br>
<input type="submit" value="MakeAsAdmin">
</div>
</form>

<form action="removeadmin" method="post" class="formright">
<div>
<h1>Remove Admin</h1>
<input type="hidden" name="csrfToken" value="<%= csrfToken %>"/>
Contact Number:<input type="text" name="contactnumber"><br>
<input type="submit" value="MakeAsUser">
</div>
</form>

<h1><a href="Link.jsp"><input type="button" class="udbutton" value="UpdateDetails"></a></h1>
</body>
</html>