...
<title>Change password to secure</title>
<style type="text/css">
body{
...
<body>
<form action="changepasswordwithcode" method="post" class="form">
<h1>Change Password</h1>
<input type="hidden" name="csrfToken" value="<%= csrfToken %>"/>
Enter new password:<br><input type="password" name="newpassword"><br>
Confirm new password:<br><input type="password" name="confirmpassword"><br>
