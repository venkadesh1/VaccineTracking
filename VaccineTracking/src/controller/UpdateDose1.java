...
@WebServlet("/updatedose1")
public class UpdateDose1 extends HttpServlet
{
	public void doPost(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
	{
		...
		String date1=req.getParameter("dateoffirstdose");
		...
		String l2="location='UpdateDose1.jsp';";
		...
		{
			out.println(js1+"alert('Admin cannot update admin or Super admin');"+l2+js2);
		}
			...
			try {
				...
				else
				{
					synchronized(this)
					{
						...
						if(lastaffecteddb==null && date1db==null)
						{
							UpdateDose1Dao.update1(contactnumber,typeofvaccine,date1);
							out.println(js1+"alert('Date of first dose,Type of Vaccine updated');"+l1+js2);
						}
						else if(!(date1db==null))
						{
							out.println(js1+"alert('First dose date already updated');"+l1+js2);
						}
						else if(!(lastaffecteddb==null))
						{
							if(CalculateDaysBetween.getDays(lastaffecteddb, date1)<30)
							{
								out.println(js1+"alert('You can vaccinate only after "+(30-CalculateDaysBetween.getDays(lastaffecteddb, date1))+" days');"+l1+js2);
							}
							else
							{
								UpdateDose1Dao.update1(contactnumber,typeofvaccine,date1);
